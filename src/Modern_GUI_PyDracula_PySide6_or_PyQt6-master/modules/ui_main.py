...
class Ui_MainWindow(object):
        def setupUi(self, MainWindow):
                ...
                MainWindow.resize(710, 360) #1280, 720
...
"	background-repeat: no-repeat;\n"
"}\n"
"#titleLeftApp { font: 63 12pt \"Arial Semibold\"; }\n"
...
"")
        ...
        "background-repeat: no-repeat;")
                ...
                self.tableWidget.setItem(1, 0, __qtablewidgetitem24)
        ...
        def retranslateUi(self, MainWindow):
                ...
                self.comboBox_Color.setItemText(2, QCoreApplication.translate("MainWindow", u"Green", None))
                self.comboBox_Color.setItemText(3, QCoreApplication.translate("MainWindow", u"Blue", None))
